	...
	<div>
		...
		<div id="myCarousel1" class="carousel slide">
		  ...
		  <ul class="thumbnails">
			<li class="span3">
			  ...
			  <a href="#" class="tag" src="front/assets/products/new.png"></a>
				<a  href="product_details.html"><img src="front/assets/products/1.jpg" alt=""/></a>
				<div class="caption">
				  <h5>Product name</h5>
				  <p> 
					Lorem Ipsum is simply dummy text. 
			...
			<li class="span3">
			  <div class="thumbnail">
			  <a href="#" class="tag" src="front/assets/products/new.png"></a>
				<a  href="product_details.html"><img src="front/assets/products/2.jpg" alt=""/></a>
				<div class="caption">
				  <h5>Product name</h5>
				  <p> 
					Lorem Ipsum is simply dummy text. 
			...
			<li class="span3">
			  <div class="thumbnail">
			  <a href="#" class="tag" src="front/assets/products/new.png"></a>
				<a  href="product_details.html"><img src="front/assets/products/3.jpg" alt=""/></a>
				<div class="caption">
				  <h5>Product name</h5>
				  <p> 
					Lorem Ipsum is simply dummy text. 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a  href="product_details.html"><img src="front/assets/products/4.jpg" alt=""/></a>
				<div class="caption">
				  <h5>Product name</h5>
				  <p> 
					Lorem Ipsum is simply dummy text . 
		  ...
		  <ul class="thumbnails">
			<li class="span3">
			  <div class="thumbnail">
				<a  href="product_details.html"><img src="front/assets/products/5.jpg" alt=""/></a>
				<div class="caption">
				  <h5>Product name</h5>
				  <p> 
					Lorem Ipsum is simply dummy text. 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a  href="product_details.html"><img src="front/assets/products/6.jpg" alt=""/></a>
				<div class="caption">
				  <h5>Product name</h5>
				  <p> 
					Lorem Ipsum is simply dummy text. 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a  href="product_details.html"><img src="front/assets/products/7.jpg" alt=""/></a>
				<div class="caption">
				  <h5>Product name</h5>
				  <p> 
					Lorem Ipsum is simply dummy text. 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a  href="product_details.html"><img src="front/assets/products/8.jpg" alt=""/></a>
				<div class="caption">
				  <h5>Product name</h5>
				  <p> 
					Lorem Ipsum is simply dummy text. 
		  ...
		  <ul class="thumbnails">
			<li class="span3">
			  <div class="thumbnail">
				<a  href="product_details.html"><img src="<c:url value="front/assets/products/9.jpg"/>" alt=""/></a>
				<div class="caption">
				  <h5>Product name</h5>
				  <p> 
					Lorem Ipsum is simply dummy text. 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a  href="product_details.html"><img src="<c:url value="front/assets/products/10.jpg"/>" alt=""/></a>
				<div class="caption">
				  <h5>Product name</h5>
				  <p> 
					Lorem Ipsum is simply dummy text. 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a  href="product_details.html"><img src="<c:url value="front/assets/products/11.jpg"/>" alt=""/></a>
				<div class="caption">
				  <h5>Product name</h5>
				  <p> 
					Lorem Ipsum is simply dummy text. 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a  href="product_details.html"><img src="<c:url value="front/assets/products/1.jpg"/>" alt=""/></a>
				<div class="caption">
				  <h5>Product name</h5>
				  <p> 
					Lorem Ipsum is simply dummy text. 
		  ...
		  <ul class="thumbnails">
			<li class="span3">
			  <div class="thumbnail">
				<a  href="product_details.html"><img src="<c:url value="front/assets/products/2.jpg"/>" alt=""/></a>
				<div class="caption">
				  <h5>Product name</h5>
				  <p> 
					Lorem Ipsum is simply dummy text. 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a  href="product_details.html"><img src="<c:url value="front/assets/products/3.jpg"/>" alt=""/></a>
				<div class="caption">
				  <h5>Product name</h5>
				  <p> 
					Lorem Ipsum is simply dummy text. 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a  href="product_details.html"><img src="<c:url value="front/assets/products/4.jpg"/>" alt=""/></a>
				<div class="caption">
				  <h5>Product name</h5>
				  <p> 
					Lorem Ipsum is simply dummy text. 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a  href="product_details.html"><img src="<c:url value="front/assets/products/5.jpg"/>" alt=""/></a>
				<div class="caption">
				  <h5>Product name</h5>
				  <p> 
					Lorem Ipsum is simply dummy text. 
		  ...
		  <ul class="thumbnails">
			<li class="span3">
			  <div class="thumbnail">
				<a  href="product_details.html"><img src="<c:url value="front/assets/products/6.jpg"/>" alt=""/></a>
				<div class="caption">
				  <h5>Product name</h5>
				  <p> 
					Lorem Ipsum is simply dummy text. 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a  href="product_details.html"><img src="<c:url value="front/assets/products/7.jpg"/>" alt=""/></a>
				<div class="caption">
				  <h5>Product name</h5>
				  <p> 
					Lorem Ipsum is simply dummy text. 
			...
			<li class="span3">
			  <div class="thumbnail">
				<a  href="product_details.html"><img src="<c:url value="front/assets/products/8.jpg"/>" alt=""/></a>
				<div class="caption">
				  <h5>Product name</h5>
				  <p> 
					Lorem Ipsum is simply dummy text. 
