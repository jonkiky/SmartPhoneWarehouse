...
<div class="span9">
	...
	<form class="form-horizontal" >
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text" id="register_inputAddressUserName" placeholder="First Name">
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text"  name="phone" id="register_address_mobile" placeholder="phone"/> <span>You must register at least one phone number</span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
			  <input type="text"  name="mobile" id="register_address_phone" placeholder="Mobile Phone"/> 
			</div>
		</div>
	...
	<div class="control-group">
			<div class="controls">
				...
				<input class="btn btn-large" type="button" id="new_address_btn" value="New Address" />
			</div>
		</div>			
	</form>
	</div>
...
<div  id="footerSection">
             ...
             contentType: "application/json"
          		...
          		obj = JSON.parse(e);
    				if(obj.statusCode!="200"){
    					...
    					setTimeout(function(){ window.location.replace("deliveryaddress"); }, 1000);
    				}
          	});
    ...
    var check = function(){
    	var flag =true;
   		var userName=$("#register_inputAddressUserName").val();
	 	...
	 	var phone_address=$("#register_address_phone").val();
  		...
  		if(userName==""){
  			$.notify("User Name is required", "warn");
  			flag =false;
  		}
