...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Bank Information Center</title>
...
<div class="span9">
	...
	<hr class="soft"/>
		<div class="row">	  
		 <a href="../newbankinfo" class="btn btn-large"><i class=" icon-credit"></i> Add New Payment</a>
		</div>
		<div class="row">	  
			<div id="productView" class="span2">
	
			<div class="span4" id="bankInfo">
...
<div  id="footerSection">
    	 ...
    	 $.ajax({
        	  ...
        	  url:"<c:url value="/getBankInfo/"/>"+${buyer.id},
	           contentType: "application/json"
				...
				+"<div>"
				+"<p>"
				+"<b>Bank Card Number : </b>"+o.cardNumber
				+"<Br> <b>Name On Card : </b>"+o.nameOnCard
				+"<Br> <b>Expiration Date : </b>"+o.expirationDate
				+"<Br> <b>Expiration Year : </b>"+o.expirationYear
				+"</p>"
				+"<div> <a href=\"javascript:onclick=EditPayment("+o.id+")\" class=\"btn btn-large\"><i class=\" icon-credit\"></i>Edit this Payment</a>"
				+" <a href=\"javascript:onclick=deletePayment("+o.id+")\" class=\"btn btn-large\"><i class=\" icon-credit\"></i>Remove this ayment</a>"
				+" </div>"
				+"</div>";
	...
	function deletePayment(id){
		...
		$.ajax({
      	  type: "GET",
      	  url:"<c:url value="/deleteBankInfo/"/>"+id,
	           contentType: "application/json"
      	}).done(function(e){
      		object = JSON.parse(e);
				if(object.statusCode!="200"){
