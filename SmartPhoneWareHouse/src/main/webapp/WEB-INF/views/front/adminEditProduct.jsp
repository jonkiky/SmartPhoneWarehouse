			...
			<div class="span6">
				<h3>
				  <input type="text" id="productName" value="  ${product.name }">
				    <input type="text" id="productBrand" value="  ${product.brand}">
				 </h3>
				   <input type="text" id="productTitle" value="  ${product.productTitle}">
				<hr class="soft"/>
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span>$<input type="text" id="price" value="${product.price } "></span></label>
					<div class="controls">
					<input type="text" id="pnumber" class="span1" value="${product.numberInStroe }"/>
					</div>
				  </div>
				</form>
            ...
            <div id="myTabContent" class="tab-content">
			  ...
			  <h4>Product Information</h4>
				...
				<tr class="techSpecRow"><th colspan="2">Product Description</th></tr>
				    ...
				    <textarea id="description" rows="4" class="span9">  ${product.des }</textarea>
				</p>
				<h3>Image </h3>
					<input  class =" span9" type="text" id="img1" class="span1" value="${product.img[0] }"/>
					<input  class =" span9" type="text" id="img2" class="span1" value="${product.img[1] }"/>
					<input  class =" span9" type="text" id="img3" class="span1" value="${product.img[2] }"/>
					<input  class =" span9" type="text" id="img4" class="span1" value="${product.img[3] }"/>
				<p>
              </div>
